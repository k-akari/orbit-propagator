...
C ### updated coefficient file names and corresponding years
        DATA  FILMOD   / 
     1    'data_source/dgrf1945.dat','data_source/dgrf1950.dat',
     2    'data_source/dgrf1955.dat','data_source/dgrf1960.dat',
     3    'data_source/dgrf1965.dat','data_source/dgrf1970.dat',
     4    'data_source/dgrf1975.dat','data_source/dgrf1980.dat',
     5    'data_source/dgrf1985.dat','data_source/dgrf1990.dat',
     6    'data_source/dgrf1995.dat','data_source/dgrf2000.dat',
     7    'data_source/dgrf2005.dat','data_source/dgrf2010.dat',
     8    'data_source/igrf2015.dat','data_source/igrf2015s.dat'/
...
100     FORMAT('Error while reading ',A25)
...
C   Initialize R1, X1, Y1, Z1
C   If rr > rh are sufficed at first try, these values are not
C   initialized and causes NaN at following steps.
C   Fixed by Kento Hoshi, 2016/11/29
            R1 = RR
            X1 = XBM1
            Y1 = YBM1
            Z1 = ZBM1
...
C   Initialize R1, X1, Y1, Z1
C   If r <= rh are sufficed at first try, these values are not
C   initialized and causes NaN at following steps.
C   Fixed by Kento Hoshi, 2016/11/29
         R1 = R
         X1 = X
